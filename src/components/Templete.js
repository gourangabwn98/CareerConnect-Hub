  ...
  return (
    <div className="flex w-11/12  max-w-[1160px] justify-between py-12 mx-auto gap-x-12 gap-y-0">
      <div className="w-11/12 max-w-[450px]">
        <h1 className="text-black font-semibold   text-[1.875] leading-[2.375rem]">
          {title}
        </h1>
        ...
        <button
          className="w-full flex justify-center rounded-[8px] font-medium text-richblack-100
    border border-richblack-700 px-[12px] py-[8px] gap-x-2 mt-1"
      ...
      <div className="relative w-11/12 max-w-[460px] mt-16">
        <img
          src={frameImage}
          alt="pattern"
          width={560}
